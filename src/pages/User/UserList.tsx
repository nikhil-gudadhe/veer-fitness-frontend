...
const UserList: React.FC<UserListProps> = ({ onEdit }) => {
    ...
    const tableData = {
        ...
        <div className="flex items-center space-x-3.5">
            ...
            <button onClick={() => toggleDropdown(user._id!)} className="hover:text-primary">
            ...
            {openDropdownId === user._id && (
                ...
                <button onClick={() => onEdit(user)} className="flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-sm hover:bg-gray dark:hover:bg-meta-4">
                ...
                <button onClick={() => handleDeleteUser(user._id!)} className="flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-sm hover:bg-gray dark:hover:bg-meta-4">
                    <svg className="fill-current" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
