...
const Invoice: React.FC = () => { 
    ...
    //                 <div>
    //                     <p className="mb-1.5 font-medium text-black dark:text-white">From</p>
    //                     <h4 className="mb-4 text-title-sm2 font-medium leading-[30px] text-black dark:text-white">Roger Culhane</h4>
    //                     <a className="block" href="/invoice"><span className="font-medium">Email: </span>contact@example.com</a><span className="mt-2 block"><span className="font-medium">Address: </span> 2972 Westheimer Rd. Santa Ana.</span>
    //                 </div>
    //                 <div>
    //                     <p className="mb-1.5 font-medium text-black dark:text-white">To</p>
    //                     <h4 className="mb-4 text-title-sm2 font-medium leading-[30px] text-black dark:text-white">Cristofer Levin</h4>
    //                     <a className="block" href="/invoice"><span className="font-medium">Email: </span>contact@example.com</a><span className="mt-2 block"><span className="font-medium">Address: </span> New York, USA 2707 Davis Anenue</span>
    //                 </div>
    //             </div>
    //             <h3 className="text-2xl font-medium text-black dark:text-white">Order #15478</h3>
    //             </div>
    //             <div className="my-10 rounded-sm border border-stroke p-5 dark:border-strokedark">
    //             <div className="items-center sm:flex">
    //                 <div className="mb-3 mr-6 h-20 w-20 sm:mb-0"><img src="https://react-demo.tailadmin.com/assets/product-thumb-07a1accf.png" alt="product" className="h-full w-full rounded-sm object-cover object-center"/></div>
    //                 <div className="w-full items-center justify-between md:flex">
    //                     <div className="mb-3 md:mb-0">
    //                         <a className="inline-block font-medium text-black hover:text-primary dark:text-white" href="/invoice">Mist Black Triblend</a>
    //                         <p className="flex text-sm font-medium"><span className="mr-5"> Color: White </span><span className="mr-5"> Size: Medium </span></p>
    //                     </div>
    //                     <div className="flex items-center md:justify-end">
    //                         <p className="mr-20 font-medium text-black dark:text-white">Qty: 1</p>
    //                         <p className="mr-5 font-medium text-black dark:text-white">$120</p>
    //                     </div>
    //                 </div>
    //             </div>
    //             </div>
    ...
    //                 <div className="mb-10">
    //                     <h4 className="mb-4 text-title-sm2 font-medium leading-[30px] text-black dark:text-white md:text-2xl">Shipping Method</h4>
    //                     <p className="font-medium">FedEx - Take up to 3 <br />working days.</p>
    //                 </div>
    //             </div>
    //             <div className="w-full px-4 sm:w-1/2 xl:w-3/12">
    //                 <div className="mb-10">
    //                     <h4 className="mb-4 text-title-sm2 font-medium leading-[30px] text-black dark:text-white md:text-2xl">Payment Method</h4>
    //                     <p className="font-medium">Apply Pay Mastercard <br />**** **** **** 5874</p>
    //                 </div>
    //             </div>
    //             <div className="w-full px-4 xl:w-6/12">
    //                 <div className="mr-10 text-right md:ml-auto">
    //                     <div className="ml-auto sm:w-1/2">
    //                         <p className="mb-4 flex justify-between font-medium text-black dark:text-white"><span> Subtotal </span><span> $120.00 </span></p>
    //                         <p className="mb-4 flex justify-between font-medium text-black dark:text-white"><span> Shipping Cost (+) </span><span> $10.00 </span></p>
    //                         <p className="mb-4 mt-2 flex justify-between border-t border-stroke pt-6 font-medium text-black dark:border-strokedark dark:text-white"><span> Total Payable </span><span> $130.00 </span></p>
    //                     </div>
    //                     <div className="mt-10 flex flex-col justify-end gap-4 sm:flex-row"><button className="flex items-center justify-center rounded border border-primary px-8 py-2.5 text-center font-medium text-primary hover:opacity-90">Download Invoice</button><button className="flex items-center justify-center rounded bg-primary px-8 py-2.5 text-center font-medium text-gray hover:bg-opacity-90">Send Invoice</button></div>
    //                 </div>
    //             </div>
    //             </div>
    //         </div>
    ...
    //                 <a className="block" href="/invoice"><span className="font-medium text-black dark:text-white">Email: </span>contact@example.com</a><span className="mt-1.5 block"><span className="font-medium text-black dark:text-white">Address: </span>2972 Westheimer Rd. Santa Ana.</span>
    //             </div>
    //             <div>
    ...
    //                 <a className="block" href="/invoice"><span className="font-medium text-black dark:text-white">Email: </span>contact@example.com</a><span className="mt-1.5 block"><span className="font-medium text-black dark:text-white">Address: </span>New York, USA 2707 Davis Anenue</span>
    //             </div>
    //             </div>
    ...
    //                         <p className="flex justify-between font-medium text-black dark:text-white"><span> Subtotal </span><span> $4700 </span></p>
    //                         <p className="flex justify-between font-medium text-black dark:text-white"><span> Shipping Cost (+) </span><span> $10.00 </span></p>
    //                         <p className="flex justify-between font-medium text-black dark:text-white"><span>Coupon Discount<span className="text-meta-3">(10%)</span></span><span> $470 </span></p>
    //                         <p className="flex justify-between font-medium text-black dark:text-white"><span> Vat <span className="text-red">(5%)</span> </span><span> $235 </span></p>
    //                     </div>
    //                     <p className="mt-4 flex justify-between border-t border-stroke pt-5 dark:border-strokedark"><span className="font-medium text-black dark:text-white">Total</span><span className="font-bold text-meta-3"> $4475 </span></p>
    ...
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="p-4 sm:p-6 xl:p-9">
            <div>
                ...
                <div>
                    <p className="mb-1.5 font-medium text-black dark:text-white">Billing From:</p>
                    <h4 className="mb-3 text-xl font-bold text-black dark:text-white">Veer Fitness</h4>
                    <a className="block" href="/invoice"><span className="font-medium text-black dark:text-white">Email: </span>contact@veerfitnessbhopal.com</a><span className="mt-1.5 block"><span className="font-medium text-black dark:text-white">Address: </span>G-2/115 Arihant Complex, Road, Gulmohar Colony, Bhopal</span>
                </div>
                <div>
                    <p className="mb-1.5 font-medium text-black dark:text-white">Billing To:</p>
                    <h4 className="mb-3 text-xl font-bold text-black dark:text-white">Naveen Richards</h4>
                    <a className="block" href="/invoice"><span className="font-medium text-black dark:text-white">Email: </span>naveenrichards@gmail.com</a><span className="mt-1.5 block"><span className="font-medium text-black dark:text-white">Mobile: </span>78699668728</span>
                </div>
                </div>
                <div className="my-7.5 grid grid-cols-1 border border-stroke dark:border-strokedark xsm:grid-cols-2 sm:grid-cols-4">
                <div className="border-b border-r border-stroke px-5 py-4 last:border-r-0 dark:border-strokedark sm:border-b-0">
                ...
                <div className="border-b border-stroke px-5 py-4 last:border-r-0 dark:border-strokedark sm:border-b-0 sm:border-r">
                    <h5 className="mb-1.5 font-bold text-black dark:text-white">Past Expiry Date :</h5>
                    <span className="text-sm font-medium">d</span>
                </div>
                <div className="border-b border-r border-stroke px-5 py-4 last:border-r-0 dark:border-strokedark xsm:border-b-0">
                    <h5 className="mb-1.5 font-bold text-black dark:text-white">New Expiry Date :</h5>
                    <span className="text-sm font-medium"> 29, Dec 2027 </span>
                </div>
                <div className="border-r border-stroke px-5 py-4 last:border-r-0 dark:border-strokedark">
                    <h5 className="mb-1.5 font-bold text-black dark:text-white">Extended On :</h5>
                    <span className="text-sm font-medium"> 29, Dec 2027 </span>
                </div>
                </div>
                <div className="border border-stroke dark:border-strokedark">
                <div className="max-w-full overflow-x-auto">
                    <div className="min-w-[670px]">
                        <div className="grid grid-cols-12 border-b border-stroke py-3.5 pl-5 pr-6 dark:border-strokedark">
                            <div className="col-span-3">
                            <h5 className="font-medium text-black dark:text-white">Membership Plan</h5>
                            </div>
                            <div className="col-span-4">
                            <h5 className="font-medium text-black dark:text-white">Description</h5>
                            </div>
                            <div className="col-span-2">
                            <h5 className="font-medium text-black dark:text-white">Duration</h5>
                            </div>

                            <div className="col-span-1">
                            <h5 className="text-right font-medium text-black dark:text-white">Amount</h5>
                            </div>
                        </div>
                        <div className="grid grid-cols-12 border-b border-stroke py-3.5 pl-5 pr-6 dark:border-strokedark">
                            <div className="col-span-3">
                            ...
                            <div className="col-span-4">
                            <p className="font-medium">Lorem ipsum set dolor amet</p>
                            </div>
                            <div className="col-span-2">
                ...
                <div className="flex justify-end p-6">
                    <div className="max-w-65 w-full">
                        <p className="mt-4 flex justify-between border-t border-stroke pt-5 dark:border-strokedark"><span className="font-medium text-black dark:text-white">Total Amount</span><span className="font-bold text-meta-3"> 200 </span></p>
                    </div>
                </div>
                </div>
            </div>
